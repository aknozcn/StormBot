		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			switch (O)
			{
				case _Options.Style1:
					...
					//-- Text
					_with9.DrawString("Kapalı", Font, new SolidBrush(BGColor), new Rectangle(19, 1, W, H), Helpers.CenterSF);
					...
					if (Checked)
					{
						...
						//-- Text
						_with9.DrawString("Açık", Font, new SolidBrush(BaseColor), new Rectangle(8, 7, W, H), Helpers.NearSF);
					}
					break;
				...
				case _Options.Style3:
					...
					//-- Text
					_with9.DrawString("Kapalı", Font, new SolidBrush(BaseColorRed), new Rectangle(-12, 2, W, H), Helpers.CenterSF);
					...
					if (Checked)
					{
						...
						//-- Text
						_with9.DrawString("Açık", Font, new SolidBrush(BaseColor), new Rectangle(12, 2, W, H), Helpers.CenterSF);
					}
					break;
